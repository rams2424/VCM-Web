...
public class FinancialInfoPage extends BasePage{
    ...
    @FindBy(xpath="//input[@id='vcm-cms-annual-income']")
    ...
    @FindBy(id="vcm-cms-taxbracket")
    WebElement Taxbracket;
    
    public void verifyTaxBracket (String arg){
        
        String Verifytax = Taxbracket.getText();
        Assert.assertTrue(arg.equalsIgnoreCase(Verifytax));
        
    }
    
    
    @FindBy(xpath="//input[@id='vcm-cms-net-worth']")
    WebElement NetWorth;
    ...
    @FindBy(xpath="//input[@id='vcm-cms-tax-filing-status']")
    WebElement TaxFilingStatus;
    
    public void TaxFilingStatus(String arg){
        TaxFilingStatus.click();
